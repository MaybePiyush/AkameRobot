...
def get_user_list(__init__, key):
    with open("{}/AkameRobot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]


# enable logging
FORMAT = "[ᴀᴋᴀᴍᴇ] %(message)s"
logging.basicConfig(
...
LOGGER.info("ᴀᴋᴀᴍᴇ ɪs sᴛᴀʀᴛɪɴɢ. | ᴀɴ 𓆩𝐏Ɨ𝒀𝐔ֆ𝙃𓆪 <Oғғʟιɴᴇ/> ᴘʀᴏᴊᴇᴄᴛ ᴘᴀʀᴛs. | ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ɢᴘʟᴠ3.")
...
SPAMWATCH_SUPPORT_CHAT = "@Chatting_Spot"
...
try:
    ...
    raise Exception(
        "[ᴀᴋᴀᴍᴇ ᴇʀʀᴏʀ]: Your ʀᴇᴅɪs ᴅᴀᴛᴀʙᴀsᴇ ɪs ɴᴏᴛ ᴀʟɪᴠᴇ, ᴘʟᴇᴀsᴇ 𝐂𝐡𝐞𝐜𝐤 ᴀɢᴀɪɴ."
    )
finally:
    REDIS.ping()
...
telegraph = Telegraph()
telegraph.create_account(short_name="AkameRobot")
