...
from Exon import Piyush as pbot
from Exon import StartTime, dispatcher, telethn, updater

# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from AkameRobot.modules import ALL_MODULES
from AkameRobot.modules.helper_funcs.chat_status import is_user_admin
from AkameRobot.modules.helper_funcs.decorators import AkameRobotcallback, AkameRobotcmd, AkameRobotnmsg
from AkameRobot.modules.helper_funcs.misc import paginate_modules
from AkameRobot.modules.language import gs
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="🏡 ᴀʙᴏᴜᴛ 🏡", callback_data="Akame_"),
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Akame.modules." + module_name)
...
@AkameRobotcallback(pattern=r"start_back")
@AkameRobotcmd(command="start", pass_args=True)
...
@AkameRobotcallback(pattern=r"help_")
    ...
    try:
        if mod_match:
            ...
            help_buttons.append(
                [
                    InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="help_back"),
                    InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="Akame_support"),
                ]
            )
            ...
            # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/Chatting_Spot'),
...
@AkameRobotcallback(pattern=r"stngs_")
...
@AkameRobotcmd(command="settings")
...
@AkameRobotmsg(Filters.status_update.migrate)
...
if __name__ == "__main__":
    log.info("[ᴀᴋᴀᴍᴇ] →  sᴜᴄᴄᴇssғᴜʟʟʏ ʟᴏᴀᴅᴇᴅ ᴍᴏᴅᴜʟᴇs: " + str(ALL_MODULES))
