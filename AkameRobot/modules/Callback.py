...
from AkameRobot import BOT_NAME, OWNER_ID, SUPPORT_CHAT
from AkameRobot import Piyush as pbot
from AkameRobot import dispatcher
...
def Akame_about_callback(update, context):
    query = update.callback_query
    if query.data == "Akame_":
        query.message.edit_text(
            ...
            "\n\n*ᴄʟɪᴄᴋ ᴏɴ ʙᴜᴛᴛᴏɴ ʙᴇʟʟᴏᴡ ᴛᴏ ɢᴇᴛ ʙᴀsɪᴄ ʜᴇʟᴘ ғᴏʀ ᴀᴋᴀᴍᴇ ʀᴏʙᴏᴛ*.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="ᴀᴅᴍɪɴs", callback_data="Akame_admin"),
                        InlineKeyboardButton(text="ɴᴏᴛᴇs", callback_data="Akame_notes"),
                    ],
                    [
                        InlineKeyboardButton(
                            text="sᴜᴘᴘᴏʀᴛ", callback_data="Akame_support"
                        ),
                        InlineKeyboardButton(
                            text="ᴄʀᴇᴅɪᴛs", callback_data="Akame_credit"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(text="🛡️", callback_data="Akame_help"),
                        InlineKeyboardButton(text="💳", callback_data="Akame_credit"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ", callback_data="Akame_"),
                    ],
                ]
            ),
        )

    elif query.data == "Akame_credit":
            text=f"━━━━━━━ *ᴄʀᴇᴅɪᴛ* ━━━━━━━"
            "\n🛡️ *ᴄʀᴇᴅɪᴛ ꜰᴏʀ ᴀᴋᴀᴍᴇ ʀᴏʙᴏᴛ* 🛡️"
            "\n\nʜᴇʀᴇ ɪꜱ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴀɴᴅ"
            f"\nꜱᴘᴏɴꜱᴏʀ ᴏꜰ [{BOT_NAME}](t.me/Akame_Robot)"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="🏡", callback_data="start_back"),
                        InlineKeyboardButton(text="🛡️", callback_data="Akame_admin"),
                        InlineKeyboardButton(text="💳", callback_data="Akame_help"),
                        InlineKeyboardButton(text="🧑‍", callback_data="source_"),
                        InlineKeyboardButton(text="🖥️", callback_data="help_back"),
                    ],
                    [
                        InlineKeyboardButton(
                            text="𓆩𝐏Ɨ𝒀𝐔ֆ𝙃𓆪 <Oғғʟιɴᴇ/>", url="https://t.me/SexyPiyush"
                        ),
                        InlineKeyboardButton(
