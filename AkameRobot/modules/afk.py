...
from AkameRobot import Piyush
from AkameRobot.modules.helper_funcs.readable_time import get_readable_time
from AkameRobot.modules.no_sql.afk_db import add_afk, is_afk, remove_afk


@Piyush.on_message(filters.command(["afk", "brb"]))
