...
import AkameRobot.modules.sql.antilinkedchannel_sql as sql
from AkameRobot import SUPPORT_CHAT, TOKEN, dispatcher
from AkameRobot.modules.helper_funcs.anonymous import AdminPerms, user_admin
from AkameRobot.modules.helper_funcs.chat_status import bot_admin, bot_can_delete
from AkameRobot.modules.helper_funcs.chat_status import user_admin as u_admin
from AkameRobot.modules.helper_funcs.decorators import AkameRobotcmd, AkameRobotmsg
from AkameRobot.modules.sql import acm_sql


@AkameRobotcmd(command="antilinkedchan", group=112)
@bot_can_delete
...
@AkameRobotmsg(Filters.is_automatic_forward, group=111)
...
@AkameRobotmsg(Filters.is_automatic_forward | Filters.status_update.pinned_message, group=113)
def eliminate_linked_channel_msg(update: Update, _: CallbackContext):
    message = update.effective_message
    chat = update.effective_chat
